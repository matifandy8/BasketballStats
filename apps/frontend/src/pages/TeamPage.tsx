    ...
    <div className="bg-gradient-to-t from-black to-transparent py-8 px-2 container mx-auto">
      {team ? (
        <div className="text-white">
          <h1 className="text-2xl font-bold mb-6 text-center py-8 font-druk">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-16">
            {team.players.map(player => (
              <div
                key={player.id}
                style={{ background: `linear-gradient(to bottom, ${primaryColor}, #1a1a1a)` }}
                className="flex flex-col items-start rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transform transition duration-300 p-4"
              >
                <img
                ...
                <div className="flex flex-col items-start justify-start">
                  ...
                  <p className="text-lg font-proxima-nova mb-2 text-left">
        ...
        <div className="bg-gradient-to-t from-black to-transparent py-8 px-2 container mx-auto">
          <h2 className="text-white text-center font-druk font-bold text-2xl py-8 h-screen">
            Team not found. Please try again later.{' '}
          </h2>
        </div>
      )}
    </div>

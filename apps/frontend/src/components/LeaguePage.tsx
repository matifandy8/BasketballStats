...
const LeaguePage: React.FC<LeaguePageProps> = ({ leagueName, leagueSlug, description }) => {
    const sections = [
        ...
        },
        {
            ...
            bgColor: 'bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/30 dark:to-stone-900',
            hoverColor: 'hover:shadow-lg hover:-translate-y-1',
            borderColor: 'border border-stone-200 dark:border-stone-700'
        },
        {
            ...
            bgColor: 'bg-gradient-to-br from-yellow-50 to-white dark:from-yellow-900/30 dark:to-stone-900',
            hoverColor: 'hover:shadow-lg hover:-translate-y-1',
            borderColor: 'border border-stone-200 dark:border-stone-700'
        },
    ];
                ...
                <div className="bg-white/80 dark:bg-stone-800/50 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-700 overflow-hidden backdrop-blur-sm">
                    <div className="p-6 md:p-8">
                        ...
                        <div className="space-y-4">
                            {[1, 2].map((item) => (
                                <div key={item} className="p-5 bg-white/50 dark:bg-stone-700/30 rounded-xl hover:bg-stone-100/50 dark:hover:bg-stone-700/50 transition-colors backdrop-blur-sm">
